...
#include "stdafx.h"
#include "carve/input.hpp"//<carve/input.hpp>
#include "carve/poly_decl.hpp"//<carve/poly_decl.hpp>
#include "carve/csg.hpp"//<carve/csg.hpp>
#include "write_ply.hpp"//<write_ply.hpp>
